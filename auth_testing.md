...
```bash
# Test auth endpoint
curl -X GET "https://your-app.com/api/auth/session/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test AI video generation
curl -X POST "https://your-app.com/api/video/generate" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"title": "Test Video", "input_text": "Create a video about AI"}'

# Test get projects
curl -X GET "https://your-app.com/api/video/projects" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
✅ /api/auth/session/me returns user data
